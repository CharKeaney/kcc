...
SemanticAnnotatorExitCode visit_external_declaration_1(
	AnnotatedAstNode* const& node,
	SymbolTable* file);

SemanticAnnotatorExitCode visit_function_definition_1(
	AnnotatedAstNode* const& node,
	SymbolTable* file);

SemanticAnnotatorExitCode get_init_declarator_symbol(
	AnnotatedAstNode* init_declarator,
	const char*& lexeme);

SemanticAnnotatorExitCode get_declarator_symbol(
	AnnotatedAstNode* declarator,
	const char*& lexeme);

SemanticAnnotatorExitCode get_init_declarator_symbols(
	AnnotatedAstNode* init_declarator,
	const char**& lexeme);

SemanticAnnotatorExitCode get_init_declarator_type(
	AnnotatedAstNode* init_declarator,
	Type const& declaration_specifier_type,
	Type*& init_declarator_type);

SemanticAnnotatorExitCode get_declaration_specifiers_type(
	AnnotatedAstNode* init_declarator,
	Type& t);

SemanticAnnotatorExitCode visit_compound_statement_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode get_function_symbol(
	AnnotatedAstNode* function_definition,
	const char*& lexeme);

SemanticAnnotatorExitCode ast_node_to_unattributed_annotated_ast_node(
	AstNode* ast_node, AnnotatedAstNode*& anno_ast_node);

SemanticAnnotatorExitCode visit_argument_expression_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_postfix_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_type_name_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_unary_operator_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_cast_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_unary_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_multiplicative_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_additive_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_shift_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_relational_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_equality_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_and_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_exclusive_or_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_inclusive_or_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_logical_and_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_logical_or_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_assignment_operator_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_conditional_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_assignment_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_constant_expression_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_declaration_3(
	AnnotatedAstNode* const& node,
	const char* init_declarator_symbols[32]);

SemanticAnnotatorExitCode visit_declaration_2(
	AnnotatedAstNode* const& node,
	Type*& const declaration_specifier_type);

SemanticAnnotatorExitCode visit_storage_class_specifier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_type_specifier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_function_specifier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_declaration_specifiers_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_declaration_specifiers_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_init_declarator_2(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_init_declarator_1(
	AnnotatedAstNode* const& node,
	SymbolTable* const& declaration_scope,
	Type*& const declaration_specifier_type);

SemanticAnnotatorExitCode visit_init_declarator_list_2(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_init_declarator_list_1(
	AnnotatedAstNode* const& node,
	Type*& const declaration_specifier_type);

SemanticAnnotatorExitCode visit_enum_specifier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_typedef_name_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_struct_or_union_specifier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_type_speciier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_struct_or_union_speciier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_struct_or_union_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_struct_declaration_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_struct_declaration_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_specifier_qualifier_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_struct_declarator_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_struct_declarator_1(
	AnnotatedAstNode* const& node,
	Type*& const declaration_specifier_type);

SemanticAnnotatorExitCode visit_enumerator_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_enumerator_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_enumeration_specifier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_type_qualifier_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_declarator_1(
	AnnotatedAstNode* const& node,
	SymbolTable* const& declaration_scope,
	Type* const& declaration_specifier_type);

SemanticAnnotatorExitCode visit_direct_declarator_2(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_direct_declarator_1(
	AnnotatedAstNode* const& node,
	SymbolTable* const& declaration_scope,
	Type* const& declaration_specifier_type);

SemanticAnnotatorExitCode visit_pointer_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_type_qualifier_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_parameter_type_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_parameter_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_parameter_declaration_2(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_parameter_declaration_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_identifier_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_abstract_declarator_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_direct_abstract_declarator_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_initializer_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_initializer_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_designation_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_designator_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_designator_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_labeled_statement_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_statement_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_block_item_list_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_block_item_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_expression_statement_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_selection_statement_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_iteration_statement_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_jump_statement_1(
	AnnotatedAstNode* const& node);

SemanticAnnotatorExitCode visit_translation_unit_1(
	AnnotatedAstNode* const& node,
	SymbolTable* file);

SemanticAnnotatorExitCode visit_function_definition_3(
	AnnotatedAstNode* const& node,
	SymbolTable* file);

SemanticAnnotatorExitCode visit_function_definition_2(
	AnnotatedAstNode* const& node,
	SymbolTable* file);

SemanticAnnotatorExitCode visit_declaration_list_1(
	AnnotatedAstNode* const& node);
	...
	Type*& init_declarator_type)
{
	...
	init_declarator_type = new Type(declaration_specifier_type);
...
static inline SemanticAnnotatorExitCode ast_node_to_unattributed_annotated_ast_node(
	AstNode* ast_node, AnnotatedAstNode*& anno_ast_node)
{
	...
	for (AstNode* c = ast_node->get_child();
		...
		if (ast_node_to_unattributed_annotated_ast_node(c, anno_c)
	...
	AnnotatedAstNode* const& node)
{
	...
	case AstNodeAlt::POSTFIX_EXPRESSION_7:
	{
		AnnotatedAstNode* postfix_expression
			= node->get_child();
		visit_postfix_expression_1(postfix_expression);
		exitcode = SemanticAnnotatorExitCode::SUCCESS;
		break;
	}
	...
	AnnotatedAstNode* const& node)
{
	...
	case AstNodeAlt::MULTIPLICATIVE_EXPRESSION_4:
	{
		AnnotatedAstNode* multiplicative_expression
			= node->get_child();
		AnnotatedAstNode* cast_expression
			= multiplicative_expression->get_child();
...
static inline SemanticAnnotatorExitCode visit_type_speciier_1(
	AnnotatedAstNode* const& node)
{
	SemanticAnnotatorExitCode exitcode
		= SemanticAnnotatorExitCode::FAIL;
...
static inline SemanticAnnotatorExitCode visit_struct_or_union_speciier_1(
	AnnotatedAstNode* const& node)
{
	SemanticAnnotatorExitCode exitcode
		= SemanticAnnotatorExitCode::FAIL;
	...
	Type* const& declaration_specifier_type)
{
	...
	case AstNodeAlt::DIRECT_DECLARATOR_1:
	{
		...
		declaration_scope->add_entry(
			identifier_lexeme);
		SymbolTableEntry* e = declaration_scope->get_entry(
			identifier_lexeme);
	...
	AnnotatedAstNode* const& node)
{
	...
	case AstNodeAlt::INITIALIZER_LIST_1:
	{
		...
		AnnotatedAstNode* initializer
			...
			: node->get_child();
		if (designation) {
			visit_designation_1(designation);
		}
		visit_initializer_1(
			initializer);
		exitcode = SemanticAnnotatorExitCode::SUCCESS;
	...
	SymbolTable* file)
{
	...
	const char* declaration_symbol = NULL;
	get_declarator_symbol(
		node->get_child()->get_sibling(),
		declaration_symbol);
	file->get_entry(declaration_symbol)->number_formal_parameters
		= number_formal_parameters;

	/* For each variable */
	AnnotatedAstNode* compound_statement =
		node->get_child()->get_sibling()->get_sibling();
	if (compound_statement->get_name()
		== AstNodeName::DECLARATION_LIST) {
		compound_statement = compound_statement->get_sibling();
	}
	SymbolTable* var_sym
		= compound_statement->get_symbol_table();
	SymbolTableEntry* var_entries[1028] = { 0 };
	var_sym->get_entries(var_entries);
	...
	SymbolTable* const& file)
{
	...
	file->add_entry(declarator_symbol);
...
static inline bool annotate(
	...
	AnnotatedAstNode*& anno_node)
{
	ast_node_to_unattributed_annotated_ast_node(
		node, anno_node
	);
